...
class Checkbook:
    ...
    Methods:
        ...
        withdraw(amount): Subtracts the specified amount from the balance if sufficient funds exist.
    ...
    def deposit(self, amount):
        """
        Deposits money into the checkbook.
    ...
    def withdraw(self, amount):
        """
        Withdraws money from the checkbook if there are sufficient funds.
